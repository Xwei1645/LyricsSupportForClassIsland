...
public partial class MLyricsNotificationProviderSettingsControl : UserControl
{
    /// <summary>
    /// 这个属性用来存储提醒提供方设置
    /// </summary>
    ...
    public LyricsNotificationProviderSettingsControl(MyNotificationSettings settings)
    {
